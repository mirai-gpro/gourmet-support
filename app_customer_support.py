...
AREA_DATA = {
    ...
    # 追加エリア（東京）
    '麻布十番': {'lat': 35.6564, 'lng': 139.7369, 'pref': '東京'},
    '麻布': {'lat': 35.6564, 'lng': 139.7369, 'pref': '東京'},
    '広尾': {'lat': 35.6517, 'lng': 139.7220, 'pref': '東京'},
    '白金': {'lat': 35.6419, 'lng': 139.7270, 'pref': '東京'},
    '白金台': {'lat': 35.6380, 'lng': 139.7230, 'pref': '東京'},
    '赤坂': {'lat': 35.6729, 'lng': 139.7372, 'pref': '東京'},
    '溜池山王': {'lat': 35.6738, 'lng': 139.7410, 'pref': '東京'},
    '虎ノ門': {'lat': 35.6686, 'lng': 139.7496, 'pref': '東京'},
    '神谷町': {'lat': 35.6636, 'lng': 139.7450, 'pref': '東京'},
    '青山': {'lat': 35.6695, 'lng': 139.7180, 'pref': '東京'},
    '外苑前': {'lat': 35.6705, 'lng': 139.7178, 'pref': '東京'},
    '神楽坂': {'lat': 35.7027, 'lng': 139.7413, 'pref': '東京'},
    '飯田橋': {'lat': 35.7020, 'lng': 139.7450, 'pref': '東京'},
    '四谷': {'lat': 35.6869, 'lng': 139.7300, 'pref': '東京'},
    '市ヶ谷': {'lat': 35.6917, 'lng': 139.7360, 'pref': '東京'},
    '神田': {'lat': 35.6918, 'lng': 139.7709, 'pref': '東京'},
    '日本橋': {'lat': 35.6823, 'lng': 139.7740, 'pref': '東京'},
    '人形町': {'lat': 35.6862, 'lng': 139.7827, 'pref': '東京'},
    '築地': {'lat': 35.6654, 'lng': 139.7707, 'pref': '東京'},
    '勝どき': {'lat': 35.6595, 'lng': 139.7769, 'pref': '東京'},
    '晴海': {'lat': 35.6540, 'lng': 139.7850, 'pref': '東京'},
    'お台場': {'lat': 35.6295, 'lng': 139.7753, 'pref': '東京'},
    '新橋': {'lat': 35.6663, 'lng': 139.7583, 'pref': '東京'},
    '汐留': {'lat': 35.6613, 'lng': 139.7620, 'pref': '東京'},
    '浜松町': {'lat': 35.6555, 'lng': 139.7569, 'pref': '東京'},
    '田町': {'lat': 35.6456, 'lng': 139.7475, 'pref': '東京'},
    '大門': {'lat': 35.6567, 'lng': 139.7540, 'pref': '東京'},
    '芝公園': {'lat': 35.6565, 'lng': 139.7510, 'pref': '東京'},
    '高輪': {'lat': 35.6358, 'lng': 139.7360, 'pref': '東京'},
    '泉岳寺': {'lat': 35.6380, 'lng': 139.7400, 'pref': '東京'},
    '大井町': {'lat': 35.6067, 'lng': 139.7350, 'pref': '東京'},
    '蒲田': {'lat': 35.5624, 'lng': 139.7161, 'pref': '東京'},
    '武蔵小山': {'lat': 35.6266, 'lng': 139.7045, 'pref': '東京'},
    '学芸大学': {'lat': 35.6285, 'lng': 139.6851, 'pref': '東京'},
    '都立大学': {'lat': 35.6188, 'lng': 139.6777, 'pref': '東京'},
    '祐天寺': {'lat': 35.6380, 'lng': 139.6920, 'pref': '東京'},
    # 神奈川
